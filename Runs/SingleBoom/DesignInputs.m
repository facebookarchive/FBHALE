...
optim.aircraft.joints           = {[4 1], [4 2], [4 3], [1 5], [1 6]};
optim.aircraft.beamNumbers      = {[1], [2], [3], [4], [5 6]};
...
optim.htail.beamNumber   = 2;
optim.vtail.beamNumber   = 3;
optim.pod.beamNumber     = [5 6];
