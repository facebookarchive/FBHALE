...
% Batteries
optim.batteries.xCG_m(1) = optim.wing.x_m + optim.wing.structure.sRefX_m{1}(fix(optim.batteries.yobo2(2)*optim.wing.structure.numStations)) ...
...
%% Pod locations
optim.pod.x_m = optim.batteries.xCG_m(1)-optim.pod.structure.length_m/2;
optim.pod.y_m = optim.batteries.y_m(1);
optim.pod.z_m = optim.batteries.zCG_m(1);
...
optim.landingGear.zCG_m = [ max(optim.pod.omlSectionsR_m{1}) max(optim.boom.omlSectionsR_m{1})];
