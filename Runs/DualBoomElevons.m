...
tic
[climbMinSOC, maxWindMissionWorstSOC, worstModeDampingRatio, SM, reversalConsistency, tipStallMargin, maxNormalStress, maxShearStress, maxRelBucklingLoad, maxTipDeflection, maxTwist_deg, batteryWeight_kg, ...
    relativeSeperationPropCenterBody, outputBatteryEnergyDensity_Wh_kg, outputSolarEff, wingSpeed_ms, divergenceLevel, deltaRollRate, isConverged, optim] = ...
